...
class Syntax {
    ...
    private Stack<String> parsingStack = new Stack<String>();
    ...
    private void stackBottom(Stack<String> stack, String current){
...
class Analyzer {
    ...
    private Stack<String> tokenStack;
    private Stack<String> tokenStack2;
